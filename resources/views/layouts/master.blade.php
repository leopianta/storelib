...
<head>
    ...
    <!-- Our Custom CSS -->
    <link rel="stylesheet" href="<?php echo asset('css/style5.css')?>">
    ...
    <script defer src="https://use.fontawesome.com/releases/v5.0.13/js/fontawesome.js"
            ...
            crossorigin="anonymous"></script>
    <script src="<?php echo asset('js/Livro.js')?>"></script>
...
<div class="wrapper">
    ...
    <nav id="sidebar">
        <div class="sidebar-header">
            <a href="#"><img src="<?php echo asset('images/logo.png')?>" height="75" width="150"></a>
        </div>
